    ...
    const makePropValue = (type, opts) => {
        ...
        const makeFinalOpts = (defaultOpts, newOpts) => {
            ...
            if(newOpts && typeof newOpts !== 'object'){
                console.warn("[fackJSON]: Option should be Object type")
        ...
        switch(type){
            case 'currency': {
                ...
                if(opts && opts.min > opts.max){
                    console.warn("[fackJSON]: Min should be less than Max")
                    opts.min = defaultOpts.min
            ...
            case 'date': {
                ...
                if(startYear > endYear){
                    console.warn("[fackJSON]: Start year should be less than End year")
                    return output
                }
